...
namespace Celer.Views.Pages.Settings
{
	public partial class SettingsGeneralViewModel : SettingsBaseViewModel
	{
		...
		partial void OnEnableSurfScapeGatewayChanged(bool value)
		{
			...
			WeakReferenceMessenger.Default.Send(new SurfScapeGatewayChangedMessage(value));
			MainConfiguration.Default.Save();
		}
		...
		public class SurfScapeGatewayChangedMessage(bool value) : ValueChangedMessage<bool>(value) { }
	}
}
