...
namespace Celer.ViewModels.OtimizacaoVM
{
    public partial class MemoryViewModel : ObservableObject
    {
        ...
        [ObservableProperty] private MemoryInfo memory;
        ...
        private void ShowTaskDialog()
        {
            if (TaskDialog.OSSupportsTaskDialogs)
            {
                ...
                dialog.Content = "Esta operação irá solicitar ao Windows que execute tarefas pendentes para libertar memória adicional. Durante este processo, poderá ocorrer alguma instabilidade no sistema, pelo que não é recomendado utilizar o computador enquanto a operação decorre.";
                dialog.Footer = "Esta mensagem é apresentada pelo serviço de memória do Celer. Para mais informações sobre o seu funcionamento, consulte: <a href=\"https://surfscape.github.io/blueprint/celer/services/memory\">surfscape.github.io/blueprint/celer/services/memory</a>.";
            ...
            {
                MessageBox.Show("O sistema não suporta TaskDialog, verifique se está a executar o Celer no Windows 10/11 e que tem a última versão de .NET 9 instalada", "TaskDialog Failure");
            }
        }
